    ...
    */
    $('#confirm-remove-now-dialog').click(function() {
        ...
        if (hasArea == false) {
            ...
            $.ajax({
                type: 'POST',
                url: "/devices/device_diagnostics/remove",
...
//        $('.ui-dialog-title').html('Are you sure you want to remove ' + listAreaBeRemove + '?');
    ...
    */
    ...
    $(".row_diagnostic").click(function() {
        window.location = $(this).data("href");
    });

    $("#confirm-remove-diagnostics").click(function() {
        window.location = $(this).data("href");
    });

        $("#back-diagnostics").click(function() {
            window.location = $(this).data("href");
        });
    ...
    $("#requested").click(function() {
        ...
        var totalParam = '';
        totalParam = "/devices/device_diagnostics/"+deviceId+"/0";
    ...
    $("#completed").click(function() {
        var deviceId = $("#remove-dialog-input").attr('value');
        var totalParam = '';
        totalParam = "/devices/device_diagnostics/"+deviceId+"/1";
        window.location.href = totalParam;
    });
    ...
    $("#errors").click(function() {
        var deviceId = $("#remove-dialog-input").attr('value');
        var totalParam = '';
        totalParam = "/devices/device_diagnostics/"+deviceId+"/2";
        window.location.href = totalParam;
    });
    ...
    function pagingDataModel(index, limit) {
            var deviceId = $("#remove-dialog-input").attr('value');
            var totalParam = '';
            totalParam = "/devices/device_diagnostics/"+deviceId+"?indexPage=" + index + "&limit=" + limit;
            window.location.href = totalParam;
    }
    ...
    $('.go-page-btn').click(function () {
        ...
        /*$("#DiagnosticsState").prop('disabled', true);*/
